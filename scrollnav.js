var scrollnav = (function () {
  ...
  var init = function(options) {
    ...
    for(var i = 0; i < rows.length; i++) {
      ...
      li.dataset.id = i;//rows[i].querySelector(content).className.replace('nav-content ', '');
      li.dataset.title = rows[i].querySelector(title).innerHTML;
